...
wp_enqueue_style( 'nova-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_register_style('nova-main-style', get_template_directory_uri() . '/' .'/assets/css/main.css', '', _S_VERSION);
	wp_enqueue_style('nova-main-style');
	wp_style_add_data( 'nova-style', 'rtl', 'replace' );
	/* Vendor JS */
	wp_register_script('nova-vendor-script', get_template_directory_uri() . '/' . '/js/vendor.js', array('jquery'), _S_VERSION, true);
	wp_enqueue_script('nova-vendor-script');
	// nova main js
	wp_register_script('nova-main-js', get_template_directory_uri() . '/' . '/assets/js/main.js', array('jquery'), _S_VERSION, true);
	wp_enqueue_script('nova-main-js');
